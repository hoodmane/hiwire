...
int main() {
    ...
    ASSERT(ref_to_int(hiwire_get_value(id1)) == 7);
    ...
    ASSERT(ref_to_int(hiwire_get_value(id2)) == 8);
    ASSERT(is_null(hiwire_get_value(id1)));
    hiwire_decref(id2);
    ...
    ASSERT(ref_to_int(hiwire_get_value(id4)) == 59);
    ...
    ASSERT(ref_to_int(hiwire_get_value(id3)) == 678);
    return 0;
}
