...
int main() {
    ...
    ASSERT_EQ(ref_to_int(hiwire_get_value(id2)), 7);
    ASSERT_EQ(ref_to_int(hiwire_get_value(id3)), 10);
    ASSERT_EQ(ref_to_int(hiwire_get_value(id4)), 12);
    ...
    ASSERT(is_null(hiwire_get_value(id1)));
    ASSERT_EQ(ref_to_int(hiwire_get_value(id2)), 7);
    ASSERT(is_null(hiwire_get_value(id3)));
    ASSERT_EQ(ref_to_int(hiwire_get_value(id4)), 12);
    ASSERT_EQ(_hiwire_num_keys(), 2);
    hiwire_decref(id2);
    ASSERT_EQ(_hiwire_num_keys(), 1);
    ...
    ASSERT_EQ(_hiwire_num_keys(), 0);
    ASSERT(is_null(hiwire_get_value(id1)));
    ASSERT(is_null(hiwire_get_value(id2)));
    ASSERT(is_null(hiwire_get_value(id3)));
    ASSERT(is_null(hiwire_get_value(id4)));
    return 0;
}
