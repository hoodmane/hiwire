...
_hiwire_delete(int index) {
  __builtin_wasm_table_set(_hiwire_table, index, __builtin_wasm_ref_null_extern());
}

int _hiwire_set(int index, __externref_t value) {
